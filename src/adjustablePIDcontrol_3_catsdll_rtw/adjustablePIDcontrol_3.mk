...
#
# File    : adjustablePIDcontrol_3.mk   $Revision: 1.71.4.34 $
#
# Abstract:
...
#       file that contains 'rtwgensettings.BuildDirSuffix' see catsdll.tlc
...
MODEL                = adjustablePIDcontrol_3
MODULES              = adjustablePIDcontrol_3_data.c adjustablePIDcontrol_3_ports.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             = adjustablePIDcontrol_3.mk
...
MASTER_ANCHOR_DIR    = 
START_DIR            = D:\final_project_submission
S_FUNCTIONS          = 
S_FUNCTIONS_LIB      = 
SOLVER               = 
NUMST                = 1
...
MODELLIB                  = adjustablePIDcontrol_3lib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = adjustablePIDcontrol_3_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\adjustablePIDcontrol_3_catsdll_rtw
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)
MATLAB_INCLUDES = $(MATLAB_INCLUDES);D:\robotics_proj_matt
...
RTM_CC_OPTS = -DUSE_RTMODEL -DCATSDLL_EXPORTS
...
REQ_SRCS  = $(MODEL).$(TARGET_LANG_EXT) $(MODULES) \
            catsdll_main.c rt_sim.c  $(SOLVER) $(EXT_SRC)
...
{$(MATLAB_ROOT)\rtw\c\catsdll}.c.obj :
